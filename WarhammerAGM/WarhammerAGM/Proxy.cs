...
namespace WarhammerAGM
{
    ...
    public class ValueProxy<TValue> : Freezable, INotifyPropertyChanged
    {
        ...
        // поле для более быстрого доступа к значению ValueProperty из любого потока.
        ...
        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register(
                ...
                new PropertyMetadata(null, (d, e) => ((ValueProxy<TValue>)d).privateValue = (TValue)e.NewValue));
        ...
        {
            ValueProxy<TValue> proxy = (ValueProxy<TValue>)state;
            proxy.OnTick(proxy.privateValue);
        }

        /// <summary>Переодически вызываемый асинхронный метод, который можно использовать
